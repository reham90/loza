...
/////////////////////////////////////////////////////// search in mobile //////////////////////
 ///////// **employees-section** /////////
 var screen = new Swiper(".best-employees-section .swiper-container", {
  loop: true,
  autoplay: true,
  pagination: {
    el: ".best-employees-section .swiper-pagination",
    clickable: true,
  },
  navigation: {
    nextEl: ".best-employees-section .swiper-btn-next",
    prevEl: ".best-employees-section .swiper-btn-prev",
  },
  breakpoints: {
    0: {
      slidesPerView: 2,
